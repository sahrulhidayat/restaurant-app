...
const { default: FavoriteRestaurantSearchPresenter } = require('../src/scripts/views/liked-restaurants/favorite-restaurant-search-presenter');
const { default: FavoriteRestaurantSearchView } = require('../src/scripts/views/liked-restaurants/favorite-restaurant-search-view');
  ...
  describe('When query is not empty', () => {
    ...
    it('should show - when the restaurant returned does not contain a title', (done) => {
      document.getElementById('restaurants').addEventListener('restaurants:updated', () => {
        const restaurantNames = document.querySelectorAll('.restaurant-title');
